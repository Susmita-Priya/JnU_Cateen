...
class _traceState extends State<trace> {
  ...
  addData() async {
    String fieldValue = _statusController.text;
    if (fieldValue.isEmpty) {
      // Show error message and return without running query
      // ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      //   content: Text('Field cannot be empty'),)):
      Fluttertoast.showToast(msg: 'Please set status');
      return;
    }
    if (fieldValue == "Confirm") {
      ...
      String email = widget.documentSnapshot["email"];
      CollectionReference _collectionRef =
          FirebaseFirestore.instance.collection("cancel");
      return _collectionRef
          .doc()
          .set({
            "order_id": _idController.text,
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  readOnly: true,
                  controller: _idController = TextEditingController(
                      text: widget.documentSnapshot["order_id"].toString()),
                ...
                TextFormField(
                  readOnly: true,
                  controller: _timeController = TextEditingController(
                      text: widget.documentSnapshot["time"].toString()),
                  keyboardType: TextInputType.text,
                  decoration: InputDecoration(
                    // border: OutlineInputBorder(
                    //     borderRadius: BorderRadius.circular(8)),
